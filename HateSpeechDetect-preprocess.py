# -*- coding: utf-8 -*-
"""FernandezGladys_RealNazareno_TP1_PLN
...
## **TP1: Pre-procesamiento y análisis léxico de los datos**

## **Carga del dataset**

*Explicar brevemente la estrategia seguida, la estructura de memoria elegida para guardarlo y las características elegidas para representar los comentarios. Tener en cuenta la posibilidad (o no) de considerar la información disponible en las conversaciones.*
"""
